...
@section('content')
    <main class="p-2 flex flex-col gap-2 bg-Neutral-10 md:h-screen">
        ...
        <section class="outerCard">
            ...
            <div class="h-[1px] bg-Neutral-20 flex"></div>
            <div class="flex w-full justify-center overflow-auto">
                <iframe width="900" height="600" src="https://lookerstudio.google.com/embed/reporting/b8a25dc5-02d3-4727-a077-396434910659/page/X712D"></iframe>
            </div>
        </section>
        <section class="outerCard">
            ...
            <div class="h-[1px] bg-Neutral-20 flex"></div>
            <div class="flex w-full justify-center overflow-auto">
                <iframe width="900" height="600" src="https://lookerstudio.google.com/embed/reporting/362261b5-5ee4-4b40-bc7c-83d6c94f70d7/page/Y812D"></iframe>
            </div>
        </section>
    </main>
@endsection
