...
@section('content')
    <main class="p-2 bg-Neutral-10">
        <section class="p-4 md:p-20 flex flex-col gap-6 rounded-xl border border-Neutral-10 items-center bg-Neutral-0">
            <form action="{{ route('storePengumuman') }}" method="post" class="md:w-[480px] p-4 flex flex-col gap-12 rounded-xl border border-Neutral-10" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="flex flex-col gap-4">
                        <div id="dropZone" class="flex flex-col justify-center items-center w-full px-4 py-8 bg-Neutral-10 border-2 border-Neutral-20 border-dashed rounded-md">
                            ...
                            <div id="image-preview-container" class="hidden flex-col items-center gap-4">
                                <img id="image-preview" class="max-w-full rounded" />
